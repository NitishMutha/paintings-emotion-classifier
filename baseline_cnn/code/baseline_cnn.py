...
layer_1 = ConvPoolLayer(x,layer_1_patch_size,layer_1_features,1,image_dimension,'relu',True)
layer_2 = ConvPoolLayer(layer_1.output,layer_2_patch_size,layer_2_features, layer_1_features, 'relu',False)
layer_3 = DenselyConnectedLayer(layer_2.output,7,64,1024,'relu')
