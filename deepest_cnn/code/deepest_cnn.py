...
# Purpose: Deepest CNN for classifying emotions in images. Similair architecture to VGG
...
model_path = '../model/tf_deepest_cnn_wh_bn_nom_drop.ckpt'
print('Model Path: ' + model_path)

# Numpy variable saving directory
np_filename = '../model/deepest_cnn_variables_wh_bn_nom_drop'
np_filename_yprobs = '../model/deepest_cnn_yprobs_wh_bn_nom_drop'

# Confusion Matrix Name
cf_filename =  '../model/deepest_cnn_cf_matrix_wh_bn_nom_drop'

# Plot naming
# Accuracy
x_label_acc = 'Epoch'
y_label_acc = 'Accuracy'
filename_acc = '../../results/deepest_cnn_acc_wh_bn_nom_drop'
# Loss
x_label_loss = 'Epoch'
y_label_loss = 'Cross-Entropy Loss'
filename_loss = '../../results/deepest_cnn_loss_wh_bn_nom_drop'
...
with tf.device(device):
    ...
    layer_8 = DenselyConnectedLayer(layer_7.output,8,256,1024,'relu',keep_prob,False,True)
    # layer_9 = ReadOutLayer(layer_8.output,1024,1024,keep_prob,False)
    # Read out layer
    layer_10 = ReadOutLayer(layer_8.output,1024,emotion_classes,keep_prob,False)
...
with tf.Session() as sess:
    ...
    if(TRAINING_MODE):
        ...
        print('----Training Deepest CNN Model Running----')
        ...
        print("Deepest TF Model restored from file: ", model_path)

        saved_var = np.load(np_filename+'.npz')
        print("Deepest NP Variables restored from file: ", np_filename)
        ...
        if(CONFUSION_MATRIX):
            ...
            save_confusion_matrix(sess, cf_filename, dataset_test, emotion_classes, y_pred_cls, feed_dict)
        else:
            pass
